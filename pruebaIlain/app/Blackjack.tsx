...
const Blackjack = (props: Props) => {
    ...
    return (
        <View style={{ flex: 1, justifyContent: "center" }}>
            <View className='Jugador' style={{ backgroundColor: "lightpink", flex: 1, alignItems: "center", padding: 10 }}>
                <Text>
                    ID: {deckId}
                </Text>
                <Text>
            ...
            <View className='Banco' style={{ backgroundColor: "lightblue", flex: 1, alignItems: "center", padding: 10 }}>
                {
                    // Calcular cartas visibles si no ha terminado
                    !terminar ?
                        <Text>
                ...
                {!terminar ?
                // Si ha terminado mustra todas las cartas
